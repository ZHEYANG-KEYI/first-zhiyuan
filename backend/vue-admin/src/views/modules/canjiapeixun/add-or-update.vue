	...
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"16px","color":"#666","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="培训时间" prop="peixunshijian">
					<el-input v-model="ruleForm.peixunshijian" placeholder="培训时间" clearable  :readonly="ro.peixunshijian"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="培训时间" prop="peixunshijian">
					<el-input v-model="ruleForm.peixunshijian" placeholder="培训时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="培训地点" prop="peixundidian">
					<el-input v-model="ruleForm.peixundidian" placeholder="培训地点" clearable  :readonly="ro.peixundidian"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="培训地点" prop="peixundidian">
					<el-input v-model="ruleForm.peixundidian" placeholder="培训地点" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="date" v-if="type!='info'" label="参加时间" prop="canjiashijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.canjiashijian" 
						type="datetime"
						:readonly="ro.canjiashijian"
						placeholder="参加时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-else-if="ruleForm.canjiashijian" label="参加时间" prop="canjiashijian">
					<el-input v-model="ruleForm.canjiashijian" placeholder="参加时间" readonly></el-input>
				</el-form-item>
			</template>
...
export default {
	...
	created() {
		this.ruleForm.canjiashijian = this.getCurDateTime()
	},
	methods: {
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `canjiapeixun/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.canjiapeixunCrossAddOrUpdateFlag = false;
											this.parent.search();
