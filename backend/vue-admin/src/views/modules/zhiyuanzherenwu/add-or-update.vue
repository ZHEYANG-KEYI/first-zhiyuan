	...
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"16px","color":"#666","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="date" v-if="type!='info'" label="任务时间" prop="renwushijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.renwushijian" 
						type="datetime"
						:readonly="ro.renwushijian"
						placeholder="任务时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-else-if="ruleForm.renwushijian" label="任务时间" prop="renwushijian">
					<el-input v-model="ruleForm.renwushijian" placeholder="任务时间" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="select" v-if="type!='info'" label="志愿者账号" prop="zhiyuanzhezhanghao">
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-else-if="ruleForm.zhiyuanzhezhanghao" label="志愿者账号" prop="zhiyuanzhezhanghao">
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="date" v-if="type!='info'" label="分配时间" prop="fenpeishijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-else-if="ruleForm.fenpeishijian" label="分配时间" prop="fenpeishijian">
					<el-input v-model="ruleForm.fenpeishijian" placeholder="分配时间" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="textarea" v-if="type!='info'" label="任务要求" prop="renwuyaoqiu">
					<el-input
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else-if="ruleForm.renwuyaoqiu" label="任务要求" prop="renwuyaoqiu">
					<span :style='{"fontSize":"inherit","lineHeight":"40px","color":"inherit","fontWeight":"500","display":"inline-block"}'>{{ruleForm.renwuyaoqiu}}</span>
				</el-form-item>
	...
	data() {
		return {
			...
			rules: {
				...
				renwudidian: [
					{ required: true, message: '任务地点不能为空', trigger: 'blur' },
				],
				renwuyaoqiu: [
				],
				zhiyuanzhezhanghao: [
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `zhiyuanzherenwu/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.zhiyuanzherenwuCrossAddOrUpdateFlag = false;
											this.parent.search();
