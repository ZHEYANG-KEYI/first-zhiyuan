	...
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"16px","color":"#666","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="upload" v-if="type!='info' && !ro.xuanchuantupian" label="宣传图片" prop="xuanchuantupian">
					<file-upload
						tip="点击上传宣传图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="upload" v-else-if="ruleForm.xuanchuantupian" label="宣传图片" prop="xuanchuantupian">
					<img v-if="ruleForm.xuanchuantupian.substring(0,4)=='http'" class="upload-img" style="margin-right:20px;" v-bind:key="index" :src="ruleForm.xuanchuantupian.split(',')[0]" width="100" height="100">
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="upload" v-if="type!='info'&& !ro.huodongshipin" label="活动视频" prop="huodongshipin">
					<file-upload
						tip="点击上传活动视频"
						action="file/upload"
						:limit="1"
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else-if="ruleForm.huodongshipin" label="活动视频" prop="huodongshipin">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 30px","margin":"0 20px 0 0","color":"inherit","clipPath":"polygon(96% 0, 100% 50%, 96% 99%, 0% 100%, 0% 0%)","outline":"none","borderRadius":"4px","background":"rgba(86,178,198,.2)","width":"auto","lineHeight":"40px","fontSize":"inherit","height":"40px"}' type="text" size="small" @click="download($base.url+ruleForm.huodongshipin)">预览</el-button>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else-if="!ruleForm.huodongshipin" label="活动视频" prop="huodongshipin">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 30px","margin":"0 20px 0 0","color":"inherit","clipPath":"polygon(96% 0, 100% 50%, 96% 99%, 0% 100%, 0% 0%)","outline":"none","borderRadius":"4px","background":"rgba(86,178,198,.2)","width":"auto","lineHeight":"40px","fontSize":"inherit","height":"40px"}' type="text" size="small">无</el-button>
				</el-form-item>
			</template>
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else-if="ruleForm.huodongxiangqing" label="活动详情" prop="huodongxiangqing">
                    <span :style='{"fontSize":"inherit","lineHeight":"40px","color":"inherit","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.huodongxiangqing"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.huodongxiangqing = this.ruleForm.huodongxiangqing.replace(reg,'../../../springbootfd0t5g0m/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
