	...
	<view class="content">
		<view :style='{"padding":"240rpx 30rpx 120rpx","backgroundColor":"#DFD8CC","backgroundImage":"url(http://codegen.caihongy.cn/20231129/75a2ef6b312c4b459d7ae49148603572.png)","width":"100%","backgroundSize":"100% 400rpx","position":"relative","backgroundRepeat":"no-repeat","height":"auto"}'>
			<view v-if="user&&user.id" :style='{"padding":"0 24rpx","margin":"0 0 20rpx 0","borderRadius":"20rpx","background":"#FFFFFF","display":"flex","width":"100%","position":"relative","height":"320rpx"}' @tap="onPageTap('../user-info/user-info')" class="header" v-bind:class="{'status':isH5Plus}">
				<view :style='{"alignContent":"center","alignItems":"center","flex":"1","display":"flex","height":"100%"}' v-if="tableName=='huodongzhubanfang'" class="userinfo">
					<image :style='{"width":"100rpx","padding":"0","margin":"0 20rpx 0 0","borderRadius":"100%","height":"100rpx"}' :src="user.tupian?baseUrl+user.tupian:'/static/gen/upload.png'"></image>
					<view :style='{"width":"300rpx","margin":"0 20rpx 0 0","flex":"1","flexDirection":"column","justifyContent":"center","display":"flex"}' class="info">
						<view :style='{"width":"100%","lineHeight":"36rpx","fontSize":"24rpx","color":"#000"}'>{{user.zhubanfangzhanghao}}<text v-if="user.vip&& user.vip=='是'">(VIP)</text></view>
					</view>
					...
					<view :style='{"padding":"20rpx","borderRadius":"20rpx 20rpx 0 0","left":"20rpx","bottom":"0","background":"#D4CF5D","display":"flex","width":"calc(100% - 40rpx)","position":"absolute","justifyContent":"space-around"}' class="info">
						<view :style='{"width":"auto","lineHeight":"36rpx","fontSize":"24rpx","color":"#FFFFFF"}'>联系方式：{{user.lianxifangshi}}</view>
					</view>
				</view>
				<view :style='{"alignContent":"center","alignItems":"center","flex":"1","display":"flex","height":"100%"}' v-if="tableName=='zhiyuanzhe'" class="userinfo">
					...
					<view :style='{"width":"300rpx","margin":"0 20rpx 0 0","flex":"1","flexDirection":"column","justifyContent":"center","display":"flex"}' class="info">
						<view :style='{"width":"100%","lineHeight":"36rpx","fontSize":"24rpx","color":"#000"}'>{{user.zhiyuanzhezhanghao}}<text v-if="user.vip&& user.vip=='是'">(VIP)</text></view>
					</view>
					
					<view :style='{"padding":"20rpx","borderRadius":"20rpx 20rpx 0 0","left":"20rpx","bottom":"0","background":"#D4CF5D","display":"flex","width":"calc(100% - 40rpx)","position":"absolute","justifyContent":"space-around"}' class="info">
						<view :style='{"width":"auto","lineHeight":"36rpx","fontSize":"24rpx","color":"#FFFFFF"}'>手机号码：{{user.shoujihaoma}}</view>
					</view>
				</view>
				<view :style='{"alignContent":"center","alignItems":"center","flex":"1","display":"flex","height":"100%"}' v-if="tableName=='zhiyuanxiaozuzhang'" class="userinfo">
					...
					<view :style='{"width":"300rpx","margin":"0 20rpx 0 0","flex":"1","flexDirection":"column","justifyContent":"center","display":"flex"}' class="info">
						<view :style='{"width":"100%","lineHeight":"36rpx","fontSize":"24rpx","color":"#000"}'>{{user.xiaozubianhao}}<text v-if="user.vip&& user.vip=='是'">(VIP)</text></view>
					</view>
					
					<view :style='{"padding":"20rpx","borderRadius":"20rpx 20rpx 0 0","left":"20rpx","bottom":"0","background":"#D4CF5D","display":"flex","width":"calc(100% - 40rpx)","position":"absolute","justifyContent":"space-around"}' class="info">
						<view :style='{"width":"auto","lineHeight":"36rpx","fontSize":"24rpx","color":"#FFFFFF"}'>联系电话：{{user.lianxidianhua}}</view>
					</view>
				</view>
			...
			<view :style='{"width":"100%","height":"auto"}' class="list">
				...
				<view :style='{"width":"100%","overflow":"hidden","borderRadius":"10rpx","height":"auto"}'>
					...
					<view :style='{"width":"100%","padding":"0 24rpx","flexWrap":"wrap","background":"#ffffff","display":"flex","height":"auto"}'>
						...
						<view @tap="onPageTap('../forum-my/forum-my')" :style='{"borderColor":"#ccc","margin":"10rpx 1%","alignItems":"center","borderWidth":"0","flexDirection":"column","display":"flex","width":"23%","borderStyle":"solid","justifyContent":"center","height":"160rpx"}' class="li"
						 hover-class="hover">
							<view :style='{"color":"#d4cf5d","fontSize":"60rpx"}' class="cuIcon-scan"></view>
							<view class="text" :style='{"width":"100%","padding":"0","lineHeight":"88rpx","fontSize":"24rpx","color":"#9E9E9E","textAlign":"center"}'>我的发贴</view>
							<view :style='{"width":"28rpx","lineHeight":"28rpx","fontSize":"28rpx","color":"#999"}' class="icon iconfont "></view>
						</view>
	...
	export default {
		...
		methods: {
			...
			async getRecommendList(){
				...
				this.recommendTable = 'zhiyuanzhefuwu'
				this.recommendTitle = 'biaoti'
