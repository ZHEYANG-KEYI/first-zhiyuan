...
<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback">
	<view class="content">
		<view class="container" :style='{"width":"100%","padding":"0","position":"relative","background":"#DFD8CC","height":"auto"}'>
				...
				<view :style='{"margin":"0 0 24rpx 0","borderColor":"#D8D8D8","borderWidth":"0 0 2rpx 0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="detail-list-item title">
					<view :style='{"width":"auto","padding":"0 10rpx 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}' class="lable">活动名称：</view>
					<view :style='{"padding":"0px","margin":"0px","lineHeight":"48rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)","flex":"1"}' class="text">{{detail.huodongmingcheng}}</view>
				</view>



				<view v-if="detail.huodongshipin" class="detail-list-item video" :style='{"padding":"20rpx","margin":"0","borderColor":"#ccc","borderWidth":"0","background":"#DFD8CC","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' @tap="videoClick()">
					<video :style='{"border":"0","width":"100%","margin":"0","outline":"none","borderRadius":"8rpx","display":"block"}' id="myVideo" :src="baseUrl+detail.huodongshipin" controls></video>
				</view>
				...
				<view class="detail-list-item rich" :style='{"margin":"0 0 24rpx 0","borderColor":"#ccc","borderWidth":"0","background":"#DFD8CC","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"width":"auto","padding":"0 10rpx 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}'>活动详情：</view>
				...
				<view class="bottom-content bg-white tabbar border shop" :style='{"width":"100%","padding":"0","flexWrap":"wrap","background":"none","display":"flex","height":"auto"}'>
					...
					<button :style='{"border":"0","padding":"0 20rpx","margin":"0","color":"rgb(255, 255, 255)","background":"rgb(255, 170, 51)","width":"auto","fontSize":"28rpx","height":"80rpx"}' v-if="userid&&isAuth('huodongxinxi','私聊')" @tap="chatClick">联系TA</button>
					<button :style='{"border":"0","padding":"0 20rpx","margin":"0","color":"rgb(255, 255, 255)","background":"rgb(255, 170, 51)","width":"auto","fontSize":"28rpx","height":"80rpx"}' v-if="!userid&&isAuthFront('huodongxinxi','私聊')" @tap="chatClick">联系TA</button>
	...
	<video v-if="showVideo"
		...
		id="myVideo" :src="baseUrl+detail.huodongshipin" controls></video>
</view>
</template>
	...
	export default {
		...
		methods: {
			...
			async init(type=1){
				...
				this.title = this.detail.huodongmingcheng
				// 轮播图片
				this.swiperList = this.detail.xuanchuantupian ? this.detail.xuanchuantupian.split(",") : [];
				...
				if(type==2){
					...
					await this.$api.update('huodongxinxi',this.detail)
				}
			},
