	...
	<view :style='{"width":"100%","padding":"0","position":"relative","background":"#fff","height":"100%"}'>
		<form :style='{"width":"100%","padding":"24rpx","background":"#fff","display":"block","height":"auto"}' class="app-update-pv">
			...
			<view :style='{"padding":"12rpx 0","margin":"0 0 24rpx 0","borderColor":"#ccc","alignItems":"center","borderWidth":"0 0 2rpx 0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				...
				<input :style='{"border":"0","padding":"0px 24rpx","margin":"0px","color":"rgb(0, 0, 0)","borderRadius":"8rpx","flex":"1","background":"rgba(255, 255, 255, 0)","fontSize":"28rpx","height":"80rpx"}' :disabled="ro.peixunshijian" v-model="ruleForm.peixunshijian" placeholder="培训时间"  type="text"></input>
			</view>
			<view :style='{"padding":"12rpx 0","margin":"0 0 24rpx 0","borderColor":"#ccc","alignItems":"center","borderWidth":"0 0 2rpx 0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="">
			...
			<view :style='{"padding":"12rpx 0","margin":"0 0 24rpx 0","borderColor":"#ccc","alignItems":"center","borderWidth":"0 0 2rpx 0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				<view :style='{"width":"auto","padding":"0 20rpx","lineHeight":"80rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}' class="title">手机号码</view>
				<input :style='{"border":"0","padding":"0px 24rpx","margin":"0px","color":"rgb(0, 0, 0)","borderRadius":"8rpx","flex":"1","background":"rgba(255, 255, 255, 0)","fontSize":"28rpx","height":"80rpx"}' :disabled="ro.shoujihaoma" v-model="ruleForm.shoujihaoma" placeholder="手机号码"  type="text"></input>
			</view>
			<view :style='{"padding":"12rpx 0","margin":"0 0 24rpx 0","borderColor":"#ccc","alignItems":"center","borderWidth":"0 0 2rpx 0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				<view :style='{"width":"auto","padding":"0 20rpx","lineHeight":"80rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}' class="title">参加时间</view>
				<input :disabled="ro.canjiashijian" :style='{"border":"0","padding":"0px 24rpx","margin":"0px","color":"rgb(0, 0, 0)","borderRadius":"8rpx","flex":"1","background":"rgba(255, 255, 255, 0)","fontSize":"28rpx","height":"80rpx"}' v-model="ruleForm.canjiashijian" placeholder="参加时间" @tap="toggleTab('canjiashijian')"></input>
			</view>
		...
		<w-picker  mode="dateTime" step="1" :current="false" :hasSecond="false" @confirm="canjiashijianConfirm" ref="canjiashijian" themeColor="#333333"></w-picker>
	</view>
</view>
</template>
...
<script>
	...
	export default {
		...
		async onLoad(options) {
            this.ruleForm.canjiashijian =  this.$utils.getCurDateTime();
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`canjiapeixun`, this.ruleForm.id);
			...
			if(options.cross){
				...
				for (var o in obj){
					...
					if(o=='canjiashijian'){
					this.ruleForm.canjiashijian = obj[o];
					this.ro.canjiashijian = true;
					continue;
					}
					if(o=='crossuserid'){
		...
		methods: {
			...
			// 日长控件选择日期时间
			canjiashijianConfirm(val) {
				console.log(val)
				this.ruleForm.canjiashijian = val.result;
				this.$forceUpdate();
			},
...
//跨表计算判断
				...
				if(crossrefid && crossuserid) {
					...
					let res = await this.$api.list(`canjiapeixun`, params);
                ...
                //跨表计算
						if(this.ruleForm.id){
							await this.$api.update(`canjiapeixun`, this.ruleForm);
						}else{
							await this.$api.add(`canjiapeixun`, this.ruleForm);
						}
