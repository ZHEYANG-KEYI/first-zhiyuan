	...
	<view class="content">
		<view class="container" :style='{"width":"100%","padding":"0","position":"relative","background":"#DFD8CC","height":"auto"}'>
				...
				<view :style='{"margin":"0 0 24rpx 0","borderColor":"#D8D8D8","borderWidth":"0 0 2rpx 0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="detail-list-item title">
					<view :style='{"width":"auto","padding":"0 10rpx 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}' class="lable">主办方名称：</view>
					<view :style='{"padding":"0px","margin":"0px","lineHeight":"48rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)","flex":"1"}' class="text">{{detail.zhubanfangmingcheng}}</view>
				</view>
				...
				<view class="detail-list-item" :style='{"margin":"0 0 24rpx 0","borderColor":"#D8D8D8","borderWidth":"0 0 2rpx 0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					...
					<view style="text-decoration: underline" @tap="callClick(detail.lianxifangshi)"  class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"48rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)","flex":"1"}'>{{detail.lianxifangshi}}</view>
				</view>
				...
				<view class="detail-list-item rich" :style='{"margin":"0 0 24rpx 0","borderColor":"#ccc","borderWidth":"0","background":"#DFD8CC","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"width":"auto","padding":"0 10rpx 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}'>主办方简介：</view>
					<view class="rich-text" :style='{"padding":"0px 24rpx 24rpx 0","margin":"0","lineHeight":"48rpx","flex":"1"}'>
						<rich-text :nodes="detail.zhubanfangjianjie"></rich-text>
					</view>
				</view>
	...
	export default {
		...
		async onShow(options) {
            ...
            if(crossCleanType) {
                ...
                res = await this.$api.info('huodongzhubanfang', this.id);
                this.detail = res.data;
				this.title = this.detail.zhubanfangmingcheng
            }
		},
		destroyed: function() {
		...
		methods: {
			...
			onPayTap(){
				...
				uni.setStorageSync('paytable','huodongzhubanfang');
			...
			async onAcrossTap(tableName,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue,type=1){
				...
				uni.setStorageSync('crossTable','huodongzhubanfang');
			...
			async init(type=1){
				...
				let res = await this.$api.info('huodongzhubanfang', this.id);
				this.detail = res.data;
				...
				//修改富文本的图片样式
				this.detail.zhubanfangjianjie = this.detail.zhubanfangjianjie.replace(/img src/gi,"img style=\"width:100%;\" src");
				if(type==2){
					this.detail.discussnum++
					await this.$api.update('huodongzhubanfang',this.detail)
				}
			},
